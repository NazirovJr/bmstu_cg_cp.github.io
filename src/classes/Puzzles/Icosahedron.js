...
class Icosahedron extends Puzzle {
    constructor(size = 2, fullSpan = 200, colors = [
        "white", "blue", "red",
        "lawngreen", "skyblue", "orange", "darkolivegreen", "yellow", "lightgreen", "salmon",
        "magenta", "crimson", "indigo",
        "brown", "darkblue", "pink", "burlywood", "darkcyan", "darkmagenta","goldenrod"]
    ) {
        const grid = {};
        const stickerMap = {};
        const faces = [];
        ...
        const faceConfig = [
            {points: [rootPoints[0], rootPoints[4], rootPoints[1]], color: colors[0]},
            {points: [rootPoints[0], rootPoints[1], rootPoints[6]], color: colors[1]},
            {points: [rootPoints[0], rootPoints[6], rootPoints[9]], color: colors[2]},
            {
            ...
            {points: [rootPoints[9], rootPoints[7], rootPoints[2]], color: colors[13]},
            {
                points: [rootPoints[8], rootPoints[2], rootPoints[5]],
                color: colors[14],
            },

            {points: [rootPoints[2], rootPoints[8], rootPoints[9]], color: colors[15]},
            {
