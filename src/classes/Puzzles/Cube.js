class Cube extends Puzzle {
  constructor(size = 2, fullSpan = 250, colors = [
      "yellow", "white", "blue", "lawngreen", "red", "darkorange"]) {
    ...
    const faces = [];
    const faceConfig = [
      { fixed: "x", direction: -1, variable: ["y", "z"], color: colors[0] },
      { fixed: "x", direction: 1, variable: ["y", "z"], color: colors[1] },
      { fixed: "y", direction: -1, variable: ["z", "x"], color: colors[2] },
      { fixed: "y", direction: 1, variable: ["z", "x"], color: colors[3] },
      { fixed: "z", direction: -1, variable: ["x", "y"], color: colors[4] },
      { fixed: "z", direction: 1, variable: ["x", "y"], color: colors[5] },
    ];
