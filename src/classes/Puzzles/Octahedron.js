class Octahedron extends Puzzle {
  constructor(size = 2, fullSpan = 200, colors = [
      "white", "blue", "lawngreen", "skyblue", "red", "darkorange", "purple", "yellow"
  ]) {
    ...
    const faceConfig = [
      { points: [rootPoints[0], rootPoints[2], rootPoints[1]], color: colors[0] },
      { points: [rootPoints[0], rootPoints[1], rootPoints[4]], color: colors[1] },
      {
      ...
      { points: [rootPoints[5], rootPoints[1], rootPoints[2]], color: colors[4] },
      {
