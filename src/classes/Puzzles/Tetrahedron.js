class Tetrahedron extends Puzzle {
  constructor(size = 3, fullSpan = 200, colors = ["white", "blue",
  "lawngreen", "red"]) {
    ...
    const faceConfig = [
      ...
      { points: [rootPoints[0], rootPoints[1], rootPoints[3]], color: colors[1] },
      {
        points: [rootPoints[0], rootPoints[3], rootPoints[2]],
        color: colors[2],
      },
      { points: [rootPoints[1], rootPoints[2], rootPoints[3]], color: colors[3] },
    ];
